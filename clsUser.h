...
private:
    ...
    static  vector <stLoginRecord> _LoadLoginsDataFromFile()
    {

        vector <stLoginRecord> vRecords;
        ...
        if (MyFile.is_open())
        {
            ...
            while (getline(MyFile, Line))
            {
                ...
                stLoginRecord record = _ConvertLoginToRecord(Line);
    ...
    static stLoginRecord _ConvertLoginToRecord(string Line, string Seperator = "#//#")
    {
        vector<string> vData;
        vData = clsString::Split(Line, Seperator);
        stLoginRecord Logins;
        
        Logins.DateTime    = vData[0];
        Logins.UserName    = vData[1];
        Logins.Password    = vData[2];
        Logins.Permissions = stoi(vData[3]);
        return Logins;
    }
...
public:
    ...
    bool CheckAccessPoint(enPermissions Permissions)
    {
