...
public:
    ...
    float ExchangeAmountToUSD(float Amount)
    {
        float ToUsd = Amount / Rate();
        return ToUsd;
    }

    float Exchange(clsCurrency Currencyto, float Amount)
    {
        float ToUsd = ExchangeAmountToUSD(Amount);

        Amount = ToUsd * Currencyto.Rate();
